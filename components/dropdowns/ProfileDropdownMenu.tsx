    ...
    <Fragment>
      {
        ...
        >
          ...
          <button
            ...
            tw="w-full flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
          >
            <svg
              tw="w-5 h-5 mx-1"
              viewBox="0 0 24 24"
            ...
            <span tw="mx-1">view profile</span>
          </button>
          {/* </Link> */}
          {role === "ADMIN" && (
            // <Link href={`/admin/${id}`}>
            ...
            >
              ...
              <span tw="mx-1">Admin Dasboard</span>
            </button>
            // </Link>
          )}
...
<a
  onMouseUp={() => {
      ...
      >
        ...
        <span tw="mx-1">Keyboard shortcuts</span>
      </a>
...
// ---------------------------------
  ...
  onMouseUp={() => {
      ...
      >
        ...
        <span tw="mx-1">Company profile</span>
      </a>
  ...
  onMouseUp={() => {
      ...
      >
        ...
        <span tw="mx-1">Invite colleagues</span>
      </a>
